    ...
    def run(self, schedule=None):
        ...
        while not self.halted:
            ...
            if self.dp.memory.input_char is not None and self.dp.ps_ie:
                ...
                self.dp.eflags = self.dp.ps_flags.copy()
                self.dp.ps_ie = False
            ...
            if opcode == Opcode.OP_R:
                ...
                if funct3 == 0:
                    ...
                    take = Z == 1 or (N ^ V) == 1  # ble
                elif funct3 == 5:
                    take = Z == 0 and (N ^ V) == 0  # bgt
                elif funct3 == 6:
                    take = C == 1  # blo (unsigned <)
                elif funct3 == 7:
                    take = C == 0  # bgeu (unsigned >=)
                ...
                if funct3 == 0:  # trap
                    ...
                    self.dp.ps_flags = self.dp.eflags.copy()
                    self.dp.ps_ie = True
