    ...
    def encode_instruction(mnemonic: str, args: list, pc: int, resolve_imm_func) -> int:
        try:
            if mnemonic in _R_F3:
                ...
                return InstructionEncoder.encode_r(Opcode.OP_R, rd, rs1, rs2, _R_F3[mnemonic], _R_F7[mnemonic])
                ...
                return InstructionEncoder.encode_i(Opcode.OP_I_ALU, rd, rs1, imm, _I_ALU_F3[mnemonic])
                ...
                return InstructionEncoder.encode_s(Opcode.OP_B_BRANCH, rs1, rs2, imm, _B_F3[mnemonic])
